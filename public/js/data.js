  ...
  const services = [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "relationship", label: "Relationship with Document Owner (if not own)", type: "text" },
        { name: "ownerFirstName", label: "Document Owner — First Name", type: "text" },
        { name: "ownerMiddleName", label: "Document Owner — Middle Name", type: "text" },
        { name: "ownerLastName", label: "Document Owner — Last Name", type: "text" },
        { name: "dateOfEvent", label: "Date of Birth / Marriage / Death", type: "date" },
        { name: "placeOfEvent", label: "Place of Event (City/Municipality)", type: "text" },

        { name: "_section_parents", label: "Parent Information (for Birth Certificate)", type: "section" },
        { name: "fatherName", label: "Father's Full Name", type: "text" },
        { name: "motherMaidenName", label: "Mother's Maiden Name", type: "text" },
      ],
    },
    {
      id: "business",
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "_section_transfer", label: "Transfer Details (if applicable)", type: "section" },
        { name: "previousOwner", label: "Previous Owner Name", type: "text" },
        { name: "previousTD", label: "Previous Tax Declaration No.", type: "text" },
        { name: "modeOfTransfer", label: "Mode of Transfer", type: "select", options: ["Sale", "Donation", "Succession/Inheritance", "Exchange", "Subdivision", "Merger/Consolidation", "Other"] },
      ],
    },
    {
      id: "zoning",
